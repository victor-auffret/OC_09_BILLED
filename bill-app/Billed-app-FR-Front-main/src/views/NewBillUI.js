            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <!-- ajout de accept="image/png, image/jpeg, image/jpg, image/gif" -->
                    <input required type="file" class="form-control blue-border" data-testid="file" accept="image/png, image/jpeg, image/jpg, image/gif" />
                  </div>
                </div>
            </div>
            <div class="row">
